...
def treatment_sum(our_tuple):
    ...
    try:
        if len(our_tuple) == 2:  # если в кортеже 2 элемента, верни 1+2
            return our_tuple[0] + our_tuple[1]
    except TypeError:  # в случае исключения выведи сообщение
        return 'Нельзя сложить эти данные'
    if len(our_tuple) < 2:  # если в кортеже меньше 2 элементов, выведи сообщение
        return 'Недостаточно данных'
    else:  # иначе падай с ошибкой 'Много данных'
