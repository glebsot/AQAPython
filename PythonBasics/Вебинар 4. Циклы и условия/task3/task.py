...
def sum_digits(num):
    ...
    # summa = 0
    # for i in str(num):  # i принимает каждое значение строки num
    #     summa += int(i)  # складываем число i с summ (который аккумулирует сумму цифр)
    summa = sum(int(i) for i in str(num))  # получаем сумму всех значений из строки num преобразованных в числа
    return summa
