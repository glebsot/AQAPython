...
def scrabble(word):
    ...
    dict_points = {1: ['а', 'в', 'е', 'ё', 'и', 'н', 'о', 'р', 'с', 'т'], 2: ['д', 'к', 'л', 'м', 'п', 'у'],
                   3: ['б', 'г', 'ь', 'я'], 4: ['й', 'ы'], 5: ['ж', 'з', 'х', 'ц', 'ч'],
                   8: ['ф', 'ш', 'э', 'ю'], 10: ['щ'], 15: ['ъ']}
    summa = 0
    for letter in word:  # перебираем буквы слова
        for i in dict_points.items():  # получаем список кортежей и присваиваем
            # переменной i последовательно эти кортежи
            if letter in i[1]:  # если i входит в список из состава кортежа, тогда получаем число
                # в начале кортежа и складываем с summa
                summa += i[0]
    return summa
